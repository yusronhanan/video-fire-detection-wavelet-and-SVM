...
def run_frame_by_dir(directory, isFire, trial, dev="Training"):
    ...
    for i in range(N):
        ...
        df_energy["N-Frame"] = n_frame_list
...
def main_labelling(directories, trial, dev):
    ...
    for d in directories:
        print(dev)
        print(d[0])
        df_energy_in_main = run_frame_by_dir(d[0], d[1], trial, dev=dev)
...
dir_testing_frame_with_label = [
    ['../content/drive/My Drive/A TA/frame_testing_with_label/Fire/', True],
    # ['../content/drive/My Drive/A TA/frame_testing_with_label/Non Fire/', False],
]

main_labelling(dir_testing_frame_with_label, trial,
